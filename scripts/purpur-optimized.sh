...
if [ ! -f server.properties ]; then
  ...
  curl -o server.properties https://raw.githubusercontent.com/Vaatigames/egg-monorepo/purpur-optimized/server.properties
fi

if [ ! -f config/paper-global.yml ]; then
  echo -e "Downloading MC config/paper-global.yml"
  curl -o paper.yml https://raw.githubusercontent.com/Vaatigames/egg-monorepo/purpur-optimized/config/paper-global.yml
fi

if [ ! -f config/paper-world-defaults.yml ]; then
  echo -e "Downloading MC config/paper-world-defaults.yml"
  curl -o paper.yml https://raw.githubusercontent.com/Vaatigames/egg-monorepo/purpur-optimized/config/paper-world-defaults.yml
fi

if [ ! -f spigot.yml ]; then
  echo -e "Downloading MC spigot.yml"
  curl -o spigot.yml https://raw.githubusercontent.com/Vaatigames/egg-monorepo/purpur-optimized/spigot.yml
fi

if [ ! -f bukkit.yml ]; then
  echo -e "Downloading MC bukkit.yml"
  curl -o bukkit.yml https://raw.githubusercontent.com/Vaatigames/egg-monorepo/purpur-optimized/bukkit.yml
fi

if [ ! -f purpur.yml ]; then
  echo -e "Downloading MC purpur.yml"
  curl -o bukkit.yml https://raw.githubusercontent.com/Vaatigames/egg-monorepo/purpur-optimized/purpur.yml
fi

if [ ! -f commands.yml ]; then
  echo -e "Downloading MC commands.yml"
  curl -o bukkit.yml https://raw.githubusercontent.com/Vaatigames/egg-monorepo/purpur-optimized/commands.yml
fi